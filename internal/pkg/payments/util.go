...
func CreateBasket(tbHeadless *tebex.HeadlessClient, store *playerdb.Store, checkoutId string, packageId int, username, creatorCode, ip string) {
...
func recordCheckoutState(store *playerdb.Store, checkoutId, basketId string, err error) {
	if err != nil {
