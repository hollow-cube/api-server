...
func GetPlayerInfo(ctx context.Context, playerId string) (username, avatar string, err error) {
	...
	return playerInfo.Data.Player.Username, playerInfo.Data.Player.Avatar, nil
}
